/*! jQuery Timepicker Addon [Custom Calendar] - v1.5.3 - 2015-04-19
		...
		*/
		_updateDateTime: function (dp_inst) {
			...
			var dtTmp = (dp_inst.currentYear > 0? 
							new JalaliDate(dp_inst.currentYear, dp_inst.currentMonth, dp_inst.currentDay) : //[CC]
							new JalaliDate(dp_inst.selectedYear, dp_inst.selectedMonth, dp_inst.selectedDay)), //[CC]
			...
			this.formattedDate = $.datepicker.formatDate(dateFmt, (dt === null ? new JalaliDate() : dt), formatCfg); //[CC]
